...
class BooksRelationship(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """BooksRelationship - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this BooksRelationship.  # noqa: E501


        :return: The data of this BooksRelationship.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this BooksRelationship.


        :param data: The data of this BooksRelationship.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BooksRelationship):
            return False
