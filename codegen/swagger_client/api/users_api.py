        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method createa_userobject0" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def deletea_userobject0_with_http_info(self, user_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method deletea_userobject0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
    ...
    def deletefrom_userbooks0_with_http_info(self, user_id, book_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method deletefrom_userbooks0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
    ...
    def invoke_usergetlist0_with_http_info(self, post_user_get_list, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method invoke_usergetlist0" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def retrievea_userobject0_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method retrievea_userobject0" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def retrieveabooksobject0_with_http_info(self, user_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method retrieveabooksobject0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
    ...
    def updatea_userobject0_with_http_info(self, user_id, post_body, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method updatea_userobject0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'user_id' is set
