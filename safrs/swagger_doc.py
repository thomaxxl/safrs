...
def swagger_method_doc(cls, method_name, tags=None):
    ...
    def swagger_doc_gen(func):
        ...
        if func.__name__ == 'get':
            ...
            parameters.append({'name': model_name,
                               'in': 'body',
        ...
        parameters.append({'name': cls.object_id, # parameter id, e.g. UserId
                           'in': 'path',
                           'type': 'string',
                           'default': default_id,
                           'required' : True})
            ...
            sample_data = schema_from_object(model_name,
                                             {'data' :
                                              {'attributes' : sample_dict,
                                               'type' : table_name}})
            parameters.append({'name': 'POST body',
                               'in': 'body',
...
def swagger_relationship_doc(cls, tags=None):
    ...
    def swagger_doc_gen(func):
        ...
        parameters = [{'name': parent_class.object_id,
                       'in': 'path',
                       'type': 'string',
